	...
	<nav class="navbar navbar-expand-xl navbar-light text-center py-3">
		<div class="container">
			<a class="navbar-brand" href="index.html">
				<img loading="prelaod" decoding="async" class="img-fluid" width="160" src="{{asset('asset/user/images/logo.png')}}" alt="Issue Tracker">
			</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<!-- account btn --> <a href="{{route('hr.register.index')}}" class="btn btn-primary ms-2 ms-lg-3">Sign Up</a>
			</div>
		</div>
	</nav>
</header>