            ...
            @foreach ($comments as $comment)
                ...
                @if ($user->pivot->user_id === auth()->user()->id)
                    <div class="msg right-msg">
                        <div style=" padding: 25px; margin: 0 0 0 10px;
                ...
                @else
                    <div class="msg left-msg">
                        <div style=" padding: 25px; margin: 0 10px 10px 0 ;
                background-size: cover; background-image: url('@if (isset($img->filename)) {{ asset('storage/user/' . $img->filename . '.' . $img->extension) }}');"
                    @else{{ asset('/asset/dist/img/AdminLTELogo.png') }} @endif
                    class="img-circle
                            elevation-2" alt="User Image"></div>
